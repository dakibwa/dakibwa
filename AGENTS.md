...
- Vitals can surface aggregate health values on the public website when Dan explicitly approves it. Raw source exports, identifiers, and unreduced local dashboard artefacts still belong outside this repo.
...
- The Personal Knowledge Base surface consumes `data/akibwapedia-data.json`, generated by the private memory workspace; do not hand-copy private records into this repo.
