...
- Dan also approved the original public job statements and per-podcast listening aggregates in `data/taste-curation.json`. Spotify starts lasting at least 30 seconds and Apple episode records are separate measures; do not add them together. Missing counts remain unknown. Podcast artwork comes from verified public catalogue matches.
