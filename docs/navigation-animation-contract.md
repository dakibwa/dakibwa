...
- Career keeps the original coloured node line, logo cards, small serif mission text and selective bold emphasis. Its 280px detail (260px on phones) occupies real layout space and leaves 24–36px before the Taste divider. Keyboard, tap-to-hold, hover and Escape remain available. Narrow phones scroll the timeline natively.
