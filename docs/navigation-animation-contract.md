...
- “Building in the age of AI” stays on one line with the historical `concept-lede` serif treatment. Scale the phone type to fit its available width; do not wrap or clip the phrase. The contact row stays quietly left-aligned below the introduction, labelled Instagram, X and Email. Show X once as its mark; retain the approved handles in distinct accessible names and the existing destinations.
- Career keeps the original coloured node line, logo cards, small serif mission text and selective bold emphasis. Dates remain visible beneath every logo; the extra current-role line above the timeline is removed. Its 280px detail (260px on phones) can sit above or below the selected role with varying horizontal alignment. Placement keeps the selected role and chapter headings clear. When the box sits below the timeline, reserve its measured height and leave 24–36px before the Taste divider; above placements release that space smoothly. Keyboard, tap-to-hold, hover and Escape remain available. Narrow phones scroll the timeline natively with enough card width to read the dates.
