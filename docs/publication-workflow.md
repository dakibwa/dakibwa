...
2. Add an App Router page under `app/<route>/page.jsx`, or a `kind: "static-directory"` entry whose `staticPath` is `public/<route>/index.html` (as `/features`, `/life-map`, and `/trek` do).
