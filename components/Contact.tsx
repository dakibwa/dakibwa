  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <div className="flex items-center gap-3 text-lg text-[#1c1a17] dark:text-[#e8e2d6]">
        ...
        <a 
          ...
          className="flex items-center gap-3 text-lg text-[#1c1a17] dark:text-[#e8e2d6] hover:text-[#2a5b53] dark:hover:text-[#7ab2a8] transition-colors"
        >
